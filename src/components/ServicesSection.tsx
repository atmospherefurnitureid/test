...
export default function ServicesSection() {
    ...
    return (
        <section id="services-section" className="mx-auto w-full max-w-7xl px-6 py-24 font-poppins">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                ...
                <div className="bg-sky-700 p-8 rounded-xl border border-sky-600 flex flex-col h-full min-h-[420px] justify-between group cursor-pointer hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:bg-[#F0F9FF] hover:border-sky-100/50">
                    <div className="flex flex-col text-left">
                        ...
                        <p className="text-sky-50 text-base leading-relaxed transition-colors duration-300 group-hover:text-zinc-500 hidden md:block">
                            {t("home.services.card1.desc")}
                        </p>
                    </div>
                    <Link href="/services/desain-yang-dipersonalisasi-sepenuhnya" aria-label={t("home.services.view_details")} className="w-fit text-white font-bold text-sm underline underline-offset-8 flex items-center gap-2 hover:gap-3 transition-all duration-300 group-hover:text-sky-700 group-hover:opacity-100 mt-8">
                        {t("home.services.view_details")}
                    </Link>
                </div>

                <div className="bg-[#F0F9FF] p-8 rounded-xl border border-sky-100/50 flex flex-col h-full min-h-[420px] justify-between group cursor-pointer hover:shadow-xl transition-all duration-500 hover:-translate-y-2 hover:bg-sky-600 text-left">
                    <div className="flex flex-col">
                        ...
                        <p className="text-zinc-500 text-base leading-relaxed group-hover:text-sky-50 transition-colors duration-300 hidden md:block font-medium">
                            {t("home.services.card2.desc")}
                        </p>
                    </div>
                    <Link href="/services/kualitas-dan-ketelitian-pengerjaan" aria-label={t("home.services.view_details")} className="w-fit text-sky-700 font-bold text-sm underline underline-offset-8 flex items-center gap-2 hover:gap-3 transition-all group-hover:text-white mt-8">
                        {t("home.services.view_details")}
                    </Link>
                </div>
                ...
                <div className="bg-[#F0F9FF] p-8 rounded-xl border border-sky-100/50 flex flex-col h-full min-h-[420px] justify-between group cursor-pointer hover:shadow-xl transition-all duration-500 hover:-translate-y-2 hover:bg-sky-600 text-left">
                    ...
                    <Link href="/services/solusi-fungsional-dan-estetis" aria-label={t("home.services.view_details")} className="w-fit text-sky-700 font-bold text-sm underline underline-offset-8 flex items-center gap-2 hover:gap-3 transition-all group-hover:text-white mt-8">
                        {t("home.services.view_details")}
                    </Link>
                </div>
                ...
                <div className="bg-[#F0F9FF] p-8 rounded-xl border border-sky-100/50 flex flex-col h-full min-h-[420px] justify-between group cursor-pointer hover:shadow-xl transition-all duration-500 hover:-translate-y-2 hover:bg-sky-600 text-left">
                    ...
                    <Link href="/services/kolaborasi-untuk-hasil-terbaik" aria-label={t("home.services.view_details")} className="w-fit text-sky-700 font-bold text-sm underline underline-offset-8 flex items-center gap-2 hover:gap-3 transition-all group-hover:text-white mt-8">
                        {t("home.services.view_details")}
                    </Link>
                </div>
            </div>
