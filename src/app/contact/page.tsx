                    ...
                    <div className="flex flex-col justify-between lg:border-l lg:border-zinc-100 lg:pl-16 pt-8 lg:pt-0">
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                <a href="mailto:atmosphere.furnitureid@gmail.com" className="flex items-center gap-4 group">
                                ...
                                <a href="https://atmospherefurnitureid.com" className="flex items-center gap-4 group">
                                    <div className="w-10 h-10 rounded-full bg-zinc-50 flex items-center justify-center group-hover:bg-sky-50 transition-colors">
                                ...
                                <a href="https://instagram.com/atmosphere.furnitureid" className="flex items-center gap-4 group">
                                    <div className="w-10 h-10 rounded-full bg-zinc-50 flex items-center justify-center group-hover:bg-sky-50 transition-colors">
                                ...
                                <a href="https://wa.me/62882005824231" className="flex items-center gap-4 group" target="_blank">
                                    <div className="w-10 h-10 rounded-full bg-zinc-50 flex items-center justify-center group-hover:bg-sky-50 transition-colors">
