...
export default function Contact() {
    ...
    return (
        <main className="min-h-screen bg-white font-poppins">
            ...
            <section className="mx-auto w-full max-w-7xl px-6 pt-4 pb-20 md:pt-4">
                {/* Centered Header */}
                <div className="mb-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-16 items-stretch">
                    ...
                    <div className="rounded-[2.5rem] flex flex-col h-full">
                        <form onSubmit={handleSubmit} className="space-y-8 flex-grow">
                            ...
                            <button
                                ...
                                className={`w-full bg-sky-500 text-white rounded-xl py-4 text-base font-semibold transition-all shadow-lg active:scale-[0.98] flex items-center justify-center gap-2 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-sky-600 shadow-sky-100'}`}
                            >
                                {isSubmitting ? (
                                    <>
                    ...
                    <div className="flex flex-col justify-between lg:border-l lg:border-zinc-100 lg:pl-16 pt-8 lg:pt-0">
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                <a href="mailto:atmosphere.furnitureid@gmail.com" aria-label="Email Us" className="flex items-center gap-4 group">
                                    ...
                                    <span className="text-base font-medium text-gray-500 transition-colors">atmosphere.furnitureid@gmail.com</span>
                                </a>
                                <a href="https://atmospherefurnitureid.com" aria-label="Official Website" className="flex items-center gap-4 group">
                                    ...
                                    <span className="text-base font-medium text-gray-500 transition-colors">atmospherefurnitureid.com</span>
                                </a>
                                <a href="https://instagram.com/atmosphere.furnitureid" aria-label="Instagram" className="flex items-center gap-4 group">
                                    ...
                                    <span className="text-base font-medium text-gray-500 transition-colors">atmosphere.furnitureid</span>
                                </a>
                                <a href="https://wa.me/62882005824231" aria-label="WhatsApp" className="flex items-center gap-4 group" target="_blank">
                                    ...
                                    <span className="text-base font-medium text-gray-500 transition-colors">+62 882-0058-24231</span>
                                </a>
                            </div>
                        ...
                        <div className="mt-12 pt-8 border-t border-zinc-100">
                            <p className="text-sm font-bold text-zinc-400 uppercase tracking-[0.2em] mb-6">{t("contact.details.payment_methods")}</p>
