...
// Media and style data mapping
const servicesMediaMap = {
...
export default function ServiceContent() {
    ...
    const serviceUI = t("services.ui");
    const serviceContent = serviceItems[slug];
    const serviceMedia = servicesMediaMap[slug as keyof typeof servicesMediaMap];

    if (!isMounted) return null;

    if (!serviceContent || !serviceMedia) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-zinc-900 mb-4">{serviceUI.not_found}</h1>
